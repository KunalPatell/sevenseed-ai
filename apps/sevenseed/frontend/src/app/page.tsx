...
// at /app/.
const STARTUPS = [
  { name: "Breakdown Factor", tag: "Procore OSHA & PlanGrid", icon: HardHat,       color: "#f59e0b", link: "/breakdown/",
    desc: "Computer-vision PPE hazard scanner, weather delay risk forecaster, and CPWD DSR automated smart BOQ generator." },
  { name: "Decode Pharmacy",  tag: "GoodRx & Drugs.com",  icon: HeartPulse,    color: "#10b981", link: "/pharmacy/",
    desc: "GoodRx generic savings engine (up to 85% off), Drugs.com visual pill identifier, and Forest Ayurveda remedies." },
  { name: "AVP Emart",        tag: "Buyhatke & Smartprix", icon: ShoppingCart,  color: "#6366f1", link: "/avp-emart/",
    desc: "Buyhatke 90-day price history & Buy/Wait meter, Smartprix spec comparison matrix, and Xerve bank coupon stacker." },
  { name: "AVPU",             tag: "Duolingo & Farnam Street", icon: GraduationCap, color: "#38bdf8", link: "/avpu/",
    desc: "Duolingo daily streaks & XP, Farnam Street 8 mental models, Laws of UX auditor, and FreeCodeCamp code sandbox." },
  { name: "AVP Trust",        tag: "GiveIndia & 80G Receipts", icon: Heart,         color: "#f97316", link: "/trust/",
    desc: "GiveIndia-style transparent SHA-256 cryptographic ledger, AI beneficiary matcher, and instant 80G tax receipts." },
  { name: "Sevenforce",       tag: "CrewAI & Devin Swarms", icon: Cpu,           color: "#a855f7", link: "/sevenforce/",
    desc: "Autonomous multi-agent swarms inspired by CrewAI & Devin, live task kanban board, and human workforce ROI calculator." },
  { name: "Comonk",           tag: "Jobscan & Levels.fyi", icon: FileText,      color: "#06b6d4", link: "/comonk-ai/",
    desc: "Jobscan ATS resume keyword auditor, Interviewing.io STAR mock interview rubric, and Levels.fyi salary benchmarks." },
  { name: "Rakshak AI",       tag: "RapidSOS & Verkada", icon: ShieldCheck,   color: "#ef4444", link: "/rakshak-ai/",
    desc: "RapidSOS emergency GPS beacon, Verkada CV threat & weapon sentinel, Citizen amber alerts, and Life360 SafeWalk." },
  { name: "Sevenseed Engine", tag: "AngelList Venture Hub",icon: Server,        color: "#eab308", link: "/app/",
    desc: "AngelList VC pitch deck readiness scorer, interactive cap table equity simulator, and startup valuation engine." },
];
