...
VENTURES = [
    ...
    {"name": "Sevenforce", "sector": "AI Workforce Automation", "stage": "Live", "color": "cyan",
     "ai_stack": "LangGraph multi-agent, 7 autonomous agents, Groq LLaMA 3.3 70B, ChromaDB",
     "url": "/sevenforce/",
     "description": "Hire a team of 7 autonomous AI employees for marketing, sales, hiring, meetings, and data."},
